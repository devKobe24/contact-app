...
public class PersonCreateRequest {
    ...
    private void determineFirstNameAndLastNameState(
            String firstName,
            String lastName,
            String phoneNumber,
            String email,
    ...
    private String processNameState(NameState nameState, String firstName, String lastName, String phoneNumber, String email) {
        switch (nameState) {
    ...
    private NameState determineNameState(String firstName, String lastName) {
    ...
    private ContactState determineContactState(String phoneNumber, String email) {
